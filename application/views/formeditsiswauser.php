          ...
          <div class="col-md-6">
            ...
            <div class="card">
              <div class="card-header">
                <span class="float-left"><a href="<?php echo base_url()?>user/dashboard/datasiswa" class='btn btn-primary'><span class="fas fa-arrow-left"></span>Kembali</a></span>
              </div>
              <!-- /.card-header -->
              <?php foreach($siswa as $siswa){ ?>
              <!-- form start -->
              <form action="<?php echo base_url()?>user/Dashboard/updatesiswa" method="post">
                <div class="card-body">
